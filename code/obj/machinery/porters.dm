...
/obj/machinery/vending/port_a_nanomed
	...
	New()
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/emergency_injector/ephedrine, 5)
		...
		product_list += new/datum/data/vending_product(/obj/item/reagent_containers/syringe/formaldehyde, 3)
